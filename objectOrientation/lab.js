...
const {carb, fat, protein} = sandwich
let food = []
...
const {name: nameUpdate, email: emailUpdate} = user
user[nameUpdate] = 'Bryan G. Smith'
user[emailUpdate] = 'bryan.smith@devmounta.in'


console.log(user[nameUpdate])
console.log(user[emailUpdate])
...
let sammy = new Cat('sammy', 1, 'brown')
console.log(sammy.age)
...
const christian = new Wizard('Christian', 30, 'fire')
christian.castSpell()
...
const myFirstVehicle = new Vehicle ( 5, 'white', 175000 )
...
const myFirstMotorcycle = new Motorcycle(2, 'black', 28000, 'Suzuki', true)
...
const myFirstBoat = new Boat(10, 'white', 10000, 'bobbin around', 'sail boat', false)
