...
// ANSWER: No. This is as simple as it gets.
...
function getNumbersSquaredBetter(numbers){
  let squaredValue = numbers.map((elem) => {
    return elem * elem
  })
  return squaredValue
}
...
// ANSWER - countLetters: Linear Space
// ANSWER - countLettersRoundTwo: Linear Space


// Q: Explain how you came to your conclusions about the space complexity of each function. 
// ANSWER: In both functions the amount of space taken in RAM is going to be primarily determined by the input size
