...
if (temperature >= 80 && rain === true){
  ...
  console.log('One should wear a t-shirt and leave the umbrella at home')
} else if (temperature > 60 && rain !== true){
  console.log('One can wear a light jacket if they so choose')
} else if (temperature <= 60 && rain !==true){
  console.log('One should wear a jacket and pray it doesn\'t rain')
} else {
  console.log('You seem to be from somewhere else')
}
